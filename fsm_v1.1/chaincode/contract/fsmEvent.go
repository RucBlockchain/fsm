...
// =================================================
func (this *Routers) ClientDeposit(stub shim.ChaincodeStubInterface, args []string) (pb.Response, string) {
...
// ==========================================================================
func (this *Routers) InsurCompanyDeposit(stub shim.ChaincodeStubInterface, args []string) (pb.Response, string) {
...
// ==========================================================
//        ClientRefund - refund premium to client
// ==========================================================
func (this *Routers) ClientRefund(stub shim.ChaincodeStubInterface, args []string) (pb.Response, string) {
	var clientJSON Client
...
// ==========================================================
//        FlightDelay - save ticketStatus into state
// ==========================================================
func (this *Routers) FlightDelay(stub shim.ChaincodeStubInterface, args []string) (pb.Response, string) {
	var orderJSON Order
...
// ===============================================================================
//        InsurCompanyRefund - refund cash deposit to insurance company
// ===============================================================================
func (this *Routers) InsurCompanyRefund(stub shim.ChaincodeStubInterface, args []string) (pb.Response, string) {
...
// ==========================================================
//        Compensate - refund cash deposit to client
// ==========================================================
func (this *Routers) Compensate(stub shim.ChaincodeStubInterface, args []string) (pb.Response, string) {
	var clientJSON Client
