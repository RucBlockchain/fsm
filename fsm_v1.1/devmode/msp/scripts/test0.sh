...
echo
sleep 2
peer chaincode install -p chaincodedev/chaincode/contract -n mycc10 -v 0
...
echo
sleep 2
peer chaincode instantiate -n mycc10 -v 0 -c '{"Args":["Init"]}' -C myc
...
echo
sleep 2
peer chaincode invoke -n mycc10 -v 1.0 -c '{"Args":["clientRegist", "1", "'${cX}'", "'${cY}'"]}' -C myc
...
echo
sleep 2
peer chaincode invoke -n mycc10 -v 1.0 -c '{"Args":["insurCompanyRegist", "1", "'${iX}'", "'${iY}'"]}' -C myc
...
echo
sleep 2
boolValue=`peer chaincode query -n mycc10 -v 1.0 -c '{"Args":["check_buyTicket"]}' -C myc`
echo $boolValue
...
if [ "$boolValue" = "Query Result: false" ] ; then
  ...
  echo
  sleep 2
  peer chaincode invoke -n mycc10  -v 1.0 -c '{"Args":["buyTicket","1","1","1","11:00","'${act1}'","'${r1}'","'${s1}'"]}' -C myc
  ...
  echo
  sleep 2
  peer chaincode query -n mycc10  -v 1.0 -c '{"Args":["queryByObjectType","order"]}' -C myc
  ...
  echo
  sleep 2
  peer chaincode invoke -n mycc10  -v 1.0 -c '{"Args":["initPolicy","1"]}' -C myc

  sleep 3

  #act6="{'Args':['buyTicket','2','1','1','11:00']}"
  #r6="e1783cc808d2bf3451d7121cdc36d6b8520a5306332bc4e1cad6909263d1b4f2"
  #s6="bfd89b0a15d65f20c28acb2425002090b3e5623d59a1f979300d802089faf580"
  ...
  #echo
  #sleep 2
  #peer chaincode invoke -n mycc10  -v 1.0 -c '{"Args":["initPolicy","2"]}' -C myc
  ...
  echo
  sleep 2
  peer chaincode invoke -n mycc10 -v 1.0 -c '{"Args":["clientDeposit","1","1","1","1","12:00","'${act2}'","'${r2}'","'${s2}'"]}' -C myc
  ...
  echo
  sleep 2
  peer chaincode query -n mycc10 -v 1.0 -c '{"Args":["queryByObjectType","policy"]}' -C myc
  ...
  echo
  sleep 2
  peer chaincode invoke -n mycc10 -v 1.0 -c '{"Args":["insurCompanyDeposit","1","1","1","1","12:00","'${Act1}'","'${R1}'","'${S1}'"]}' -C myc
  sleep 3
  ...
  echo
  sleep 2
  boolValue=`peer chaincode query -n mycc10  -v 1.0 -c '{"Args":["check_flightDelay"]}' -C myc`
  echo $boolValue
  ...
  if [ "$boolValue" = "Query Result: true" ] ; then
    ...
    peer chaincode invoke -n mycc10  -v 1.0 -c '{"Args":["flightDelay","1","1","DELAY"]}' -C myc
    ...
    peer chaincode invoke -n mycc10  -v 1.0 -c '{"Args":["compensate","1","1","'${act4}'","'${r4}'","'${s4}'"]}' -C myc
    ...
    peer chaincode invoke -n mycc10  -v 1.0 -c '{"Args":["insurCompanyRefund","1","1","'${Act2}'","'${R2}'","'${S2}'"]}' -C myc
